...
1. **examples/nextjs-auth/PROMPT.md** — Prompt to generate a Next.js 15 auth middleware
2. **examples/supabase-realtime/PROMPT.md** — Prompt to generate Supabase realtime chat code
...
3. Open one of the PROMPT.md files
4. Copy the prompt and paste it into Claude
5. Claude will auto-fetch the latest docs and generate working code
